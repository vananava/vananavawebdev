...
*/
require_once ('include/adminTopMenu_function.php');
...
function vananava_order_view_order()
{
	...
	if ($order_id == "") {
		...
		header('Location: admin.php?page=vananava_order');
		exit();
	}
	...
	$item_log_contact_data = $row3["order_item_log_contact_data"];
	$item_log_ticket_data = $row3["order_item_log_ticket_data"];
	$item_log_ticket_data_code = $row3["order_item_log_ticket_data_code"];
	$item_log_contact_data_pending = $row3["order_item_log_contact_data_pending"];
	$item_log_ticket_data_pending = $row3["order_item_log_ticket_data_pending"];
	$item_log_ticket_data_code_pending = $row3["order_item_log_ticket_data_code_pending"];
...
?>
	...
	<div class="wrap">
			...
			<div id="post-body" class="metabox-holder columns-2">
				<div id="post-body-content" class="edit-form-section edit-comment-section">
					<div id="namediv" class="stuffbox">
						<div class="inside">
							<fieldset>
								<?php if ($item_log_contact_data_pending != "") { ?>
									<table role="presentation" style='width:100%;'>
										<tbody>
											<tr>
												<th style='color:#000000; border: 1px solid black; width:80%; height:40px;' align="center">
													<font style='color:#000000;'>Contact Information</font>
												</th>
											</tr>
											<?php
											$json_ctm_contact = json_decode($item_log_contact_data_pending, true);
								...
								<?php } else if ($item_log_contact_data != "") { ?>
									<table role="presentation" style='width:100%;'>
										<tbody>
											<tr>
												<th style='color:#000000; border: 1px solid black; width:80%; height:40px;' align="center">
											...
											<?php
											$json_ctm_contact = json_decode($item_log_contact_data, true);
								...
								<?php } ?>
								<br>
								<?php if ($item_log_ticket_data_pending != "") { ?>
									<table role="presentation" style='width:100%;'>
										<tbody>
											<tr>
												<th style='color:#000000; border: 1px solid black; width:80%; height:40px;' align="center">
													<font style='color:#000000;'>Ticket and Extra Items</font>
												</th>
												<th style='color:#000000; border: 1px solid black; width:10%; height:40px;' align="center">
													<font style='color:#000000;'>QTY</font>
												</th>
												<th style='color:#000000; border: 1px solid black; width:10%; height:40px;' align="center">
													<font style='color:#000000;'>Total</font>
												</th>
											</tr>
											<?php
											$json_ctm_ticket = json_decode($item_log_ticket_data_pending, true);
											...
											?>
														<tr>
															<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
																<font style='color:#000000;'><?php echo $b_ctm_ticket['ItemDescriptionMail']; ?> <br> <?php echo $b_ctm_ticket['ItemDescriptionsubMail']; ?></font>
															</td>
															<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
																<font style='color:#000000;'><?php echo $b_ctm_ticket['QuantityMail']; ?></font>
															</td>
															<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
																<font style='color:#000000;'><?php echo number_format($b_ctm_ticket['ItemCostMail']); ?></font>
															</td>
														</tr>
											<?php
													}
											...
											<tr>
												...
												<th style='color:#000000; border: 1px solid black; width:10%; height:40px;' align="center">
													<font style='color:#000000;'>Total Price</font>
												</th>
												<th style='color:#000000; border: 1px solid black; width:10%; height:40px;' align="center">
													<font style='color:#000000;'><?php echo number_format($val_ctm_ticket['TotalPaid']); ?></font>
												</th>
											</tr>
										</tbody>
									</table>
								<?php } else if ($item_log_ticket_data != "") { ?>
									<table role="presentation" style='width:100%;'>
										<tbody>
											<tr>
												<th style='color:#000000; border: 1px solid black; width:80%; height:40px;' align="center">
											...
											<?php
											$json_ctm_ticket = json_decode($item_log_ticket_data, true);
										...
										<tbody>
											...
											<tr>
												...
												<?php } else if ($rowDes0["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes0["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua0["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua0["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos0["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos0["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes1["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes1["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua1["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua1["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos1["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos1["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes2["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes2["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua2["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua2["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos2["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos2["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes3["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes3["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua3["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua3["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos3["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos3["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes4["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes4["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua4["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua4["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos4["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos4["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes5["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes5["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua5["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua5["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos5["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos5["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes6["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes6["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua6["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua6["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos6["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos6["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes7["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes7["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua7["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua7["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos7["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos7["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes8["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes8["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua8["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua8["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos8["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos8["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes9["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes9["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua9["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua9["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos9["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos9["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<?php } else if ($rowDes10["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:80%; height:30px;'>
														<font style='color:#000000;'><?php echo $rowDes10["meta_value"] ?>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowQua10["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowQua10["meta_value"] ?> </font>
													</td>
												<?php } ?>
												...
												<?php } else if ($rowCos10["meta_value"] != "") { ?>
													<td style='color:#000000; border: 1px solid black; width:10%; height:30px;' align="center">
														<font style='color:#000000;'><?php echo $rowCos10["meta_value"] ?></font>
													</td>
												<?php } ?>
											</tr>
											...
											<tr>
												...
												<th style='color:#000000; border: 1px solid black; width:10%; height:40px;' align="center">
													<font style='color:#000000;'><?php echo number_format($row10["meta_value"]); ?></font>
												</th>
											</tr>
										</tbody>
									</table>
								...
								<?php if ($item_log_ticket_data_pending != "") { ?>
									<table role="presentation" style='width:100%;'>
										<tbody>
											<tr>
												<td style='color:#000000; border: 1px solid black; width:80%; height:40px;' align="center">ส่งข้อมูล ไปที่ Centaman </td>
											...
											<tr>
												<td style='color:#000000; border: 1px solid black; width:80%; height:40px;' align="center">ส่งข้อมูล ไปที่ Email ลูกค้า (สำหรับการส่ง Email อีกครั้ง จำเป็นต้องมี Booking ID ก่อน)</td>
												<td style='color:#000000; border: 1px solid black; width:10%; height:40px;' align="center">
													<?php if ($row3["booking_id"] != "") { ?>
        ...
        <?php 
            $sql2c2p =	" SELECT * FROM vananava_wp_vnnv_log_2c2p WHERE order_id = '$order_id' ";
            $query2c2p = mysql_db_query($dbname, $sql2c2p) or die("Can't query2c2p");
			
			while($row2c2p = mysql_fetch_array($query2c2p) )
			{
				// echo $row2c2p[1]."<br>";
				// payment_status=001&channel_response_code=001&channel_response_desc=success 
				$time2c2p = stristr(stristr($row2c2p[1], 'request_timestamp'),"&",true);
				$payment2c2p = stristr(stristr($row2c2p[1], 'payment_status'),"&",true);
				$response2c2p = stristr(stristr($row2c2p[1], 'channel_response_code'),"&",true);
				$desc2c2p = stristr(stristr($row2c2p[1], 'channel_response_desc'),"&",true);
				$order2c2p = stristr(stristr($row2c2p[1], 'order_id'),"&",true);
				$hash2c2p = stristr($row2c2p[1], 'hash_value');
				
				echo "<tr><td>".$order2c2p."</td><td>".$time2c2p."</td><td>".$payment2c2p." </td><td> ".$response2c2p." : ".$desc2c2p."</td><td> ";

				echo $hash2c2p."</td><td></tr>";
			}
		?>
		</table>
		</p><p><h3>order</h3>
        <?php
            $sql2c2p =	" SELECT * FROM vananava_wp_vnnv_order_items WHERE order_id = '$order_id' ";
            $query2c2p = mysql_db_query($dbname, $sql2c2p) or die("Can't query2c2p");
			...
			while($row2c2p = mysql_fetch_array($query2c2p) )
			{
				...
				echo "<br>order_item_status ".$row2c2p[5]."<br>order_item_payment_status ".$row2c2p[6]."<br>order_item_payment_channel_name ".$row2c2p[8]." <br>order_item_payment_page ".$row2c2p[9]."<br> ";
        ...
        <?php
            $sqlctm =	" SELECT * FROM vananava_wp_vnnv_order_items WHERE order_id = '$order_id' ";
            $query2ctm = mysql_db_query($dbname, $sqlctm) or die("Can't query2ctm");

			while($row2ctm = mysql_fetch_array($query2ctm) )
			{
				// echo $row2c2p[1]."<br>";
				// payment_status=001&channel_response_code=001&channel_response_desc=success

				echo "<br>mail ".$row2ctm[23]."<hr><br>ctm ".$row2ctm[24];
...
function vananava_co_promotion_edit_new()
{
	...
	if ($co_promotion_id == "") {
		header("HTTP/1.1 301 Moved Permanently");
		header('Location: admin.php?page=vananava_co_promotion_add_new');
		exit();
	}
									...
									<table class="form-table editcomment" role="presentation">
										<tbody>
											...
											<tr>
												...
												<td>
													<select name="co_promotion_ticket_show" id="co_promotion_ticket_show">
														<option>Ticket Number Promotion</option>
													</select>
													<?php
													include('connect.php');
													$strSQL2 = " SELECT * FROM vananava_wp_vnnv_ctm_ticketmeta WHERE ctm_ticket_status = 'promotion' AND ctm_server = 'production' AND ctm_is_display = 'Y' ";
													...
													<label for="ticket_name">Ticket Number Promotion : <?= $co_promotion_ticket_show ?></label>
												</td>
											</tr>
										</tbody>
									</table>
			...
			<script type="text/javascript">
				$(function() {
					...
					$(obj2).hover(function() {
						...
						setText = (setText != "") ? setText : "Ticket Number Promotion";
						$(this).hide();
						$(obj1).html("<option value=\"" + setValue + "\">" + setText + "</option>").blur();
					});
				});
...
?>
	...
	<div align="left">
		<?php if ($Prev_Page) {
			echo " <a href='admin.php?page=vananava_co_promotion_view_new&co_promotion_id=$co_promotion_id&Page=$Prev_Page'> < Previous </a> ";
		} ?>
		<?php
		...
		?>
		<?php if ($Page1 != $Num_Pages1) {
			echo " <admin.php?page=vananava_co_promotion_view_new&co_promotion_id=$co_promotion_id&Page=$Next_Page'> Next > </a> ";
		} ?>
	</div>
<?php
							...
							<div class="inside">
								<div class="submitbox" id="submitcomment">
									<div id="minor-publishing">
										...
										<div class="clear"></div>
										<script type="text/javascript">
											function display_time_one() {
												document.getElementById('ticket_display_time').style.display = 'none';
											}

											function display_time_two() {
												document.getElementById('ticket_display_time').style.display = 'block';
											}
										</script>
										<div id="misc-publishing-actions">
											<fieldset class="misc-pub-section misc-pub-comment-status" id="comment-status-radio">
										...
										<script type="text/javascript">
											function display_time_use_one() {
												document.getElementById('ticket_display_time_use').style.display = 'none';
											}

											function display_time_use_two() {
												document.getElementById('ticket_display_time_use').style.display = 'block';
											}
										</script>
										<div id="misc-publishing-actions">
											<fieldset class="misc-pub-section misc-pub-comment-status" id="comment-status-radio">
...
function vananava_ticket_item_edit()
{
	...
	if ($ctm_ticket_ID == "") {
		header("HTTP/1.1 301 Moved Permanently");
		header('Location: admin.php?page=vananava_ticket_item_add');
		exit();
	}
...
function vananava_extra_item_edit()
{
	...
	if ($ctm_extra_ID == "") {
		header("HTTP/1.1 301 Moved Permanently");
		header('Location: admin.php?page=vananava_extra_item_add');
		exit();
	}
	...
	class Ticket_Order_List_Table extends Simple_WP_List_Table_Ticket_Order
	{
		function __construct()
		{
			parent::__construct(array(
				...
				'MobilePhone'						=> 'MobilePhone',
				'TotalPaid'							=> 'TotalPaid',
				'order_item_payment_channel_name'	=> 'order_item_payment_channel_name',
				'order_items_promotion_name'		=> 'order_items_promotion_name',
				'StartDate'							=> 'StartDate',
				'order_item_status'					=> 'order_item_status',
				'ajax'								=> false
		...
		function get_columns()
		{
			return array(
				...
				'MobilePhone'						=> __('Contact Phone'),
				'TotalPaid'							=> __('Total Cost'),
				'order_item_payment_channel_name'	=> __('Payment Channel'),
				'order_items_promotion_name'		=> __('Promotion'),
				'StartDate'							=> __('Planned Date'),
				'order_item_status'					=> __('Payment Status'),
		...
		public function get_sortable_columns()
		{
			return array(
				...
				'MobilePhone'						=> array('MobilePhone'),
				'TotalPaid'							=> array('TotalPaid'),
				'order_item_payment_channel_name'	=> array('order_item_payment_channel_name'),
				'order_items_promotion_name'		=> array('order_items_promotion_name'),
				'StartDate'							=> array('StartDate'),
				'order_item_status'					=> array('order_item_status'),
