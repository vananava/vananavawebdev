<?php
	...
	*/
	...
	// -- check referer ---
	$response_save = str_replace(array("\r\n", "\n", "\r", "\t"), '', $response);
	$referer_2c2p	=	$_SERVER['HTTP_REFERER'];

	$date_log = date("Y-m-d H:i:s");
		
	$sqlreferer = " INSERT INTO vananava_wp_log_backend2c2p (order_id, request, referer, date_log) VALUES ('$order_id', '$response_save', '$referer_2c2p', '$date_log') ";
	...
	*/
	...
	$wpdb->insert($table_vnnv_log_2c2p, array(
		...
		'order_id' => $order_id,
		'referer' => $referer_2c2p.'-----'.$checkip
	));

	} elseif ($checkip != "119.63.87.178") {
